...
public class GestionProductosView extends JFrame {
     ...
     * @param tableModel
     */
    public GestionProductosView(TableModel tableModel, DefaultComboBoxModel<String> categoriaComboBoxModelNew, DefaultComboBoxModel<String> categoriaComboBoxModelEdit) {        //jFrame
